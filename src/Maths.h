...
#define VECTOR3_X red::Vector3(1, 0, 0)
#define VECTOR3_Y red::Vector3(0, 1, 0)
#define VECTOR3_Z red::Vector3(0, 0, 1)
#define VECTOR3_ZERO red::Vector3(0, 0, 0)

class Vector4 {
public:
	float x, y, z, w;
	Vector4(float x, float y, float z, float w);
	Vector4(const red::Vector3 &xyz, float w);
	Vector4();
